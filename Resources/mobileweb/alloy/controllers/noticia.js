function Controller() {
    ...
    closeNews ? $.__views.rowContainer.addEventListener("swipe", closeNews) : __defers["$.__views.rowContainer!swipe!closeNews"] = true;
    ...
    __defers["$.__views.rowContainer!swipe!closeNews"] && $.__views.rowContainer.addEventListener("swipe", closeNews);
    _.extend($, exports);
}
